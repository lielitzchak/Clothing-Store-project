...
//                 </div>
//                 <div>
//                     <a onclick=" add_$(${item[i].id})" href="" id="${item[i].id}">
//                     <img src="${shopping_cart_img}" class="shopping_img_cart_add add_${item[i].id}"> </a>
//                     <a onclick=" remove_$(${item[i].id}}, '${item[i].itemName}', ${item[i].price}, '${item[i].category}')" href="#" id="remove_${item[i].id}"><img src="${delete_item}" class="shopping_img_cart_remove"> </a>
//                     <p class="text_on_img">Click on the image to see more</p>
