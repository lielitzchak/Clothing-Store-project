    ...
    div_for_main.innerHTML += `
            <div class="div_for_sections">
              <section  class="section_category_mobile">
                  ...
                  <div>
                  <a id="add_${item[i].id}"> <img src="../media/photos/icons8-shopping-cart-64.png" class="shopping_img_cart_add add_${item[i].id}"> </a>
                  <a id="remove_${item[i].id}"><img src="../media/photos/icons8-delete-50.png" class="shopping_img_cart_remove"> </a>
